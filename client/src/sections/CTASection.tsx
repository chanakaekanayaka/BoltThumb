        ...
        <div className="relative px-4 pb-32 mt-20">
            ...
            >
                ...
                <div className="text-center md:text-left flex-1">
                    ...
                    >
                        Ready to <span className="text-rose-500 italic">Bolt</span> your views?
                    </motion.h2>
                    <motion.p 
                ...
                >
                    <button className="group relative flex items-center gap-3 px-10 py-5 bg-rose-600 hover:bg-rose-500 text-white font-black text-xl rounded-full transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(225,29,72,0.3)]">
