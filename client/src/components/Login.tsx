            ...
            <div className='min-h-screen flex items-center justify-center'>
                ...
                <form
                    ...
                    {state !== "login" && (
                        ...
                        ring-white/10 focus-within:ring-rose-500/60 h-12 rounded-full 
                        overflow-hidden pl-6 gap-2 transition-all ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-white/60"
                                strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"> <circle cx="12" cy="8"
                                    r="5" /> <path d="M20 21a8 8 0 0 0-16 0" /> </svg>
                            <input type="text" name="name" placeholder="Name"
                                className="w-full bg-transparent text-white
                                placeholder-white/60 border-none outline-none "
                    ...
                    <div className="mt-4 text-left">
                        <button type="button" className="text-sm text-rose-400 hover:underline">
                            Forget password?
                        </button>
                    </div>

                    <button type="submit" className="mt-2 w-full h-11 rounded-full text-white bg-rose-900 hover:bg-rose-800 transition shadow-lg shadow-rose-900/20 font-medium" >
                        {state === "login" ? "Login" : "Sign up"}
                    </button>
