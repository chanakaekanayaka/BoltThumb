              ...
              border border-white/10 transition shadow-xl break-inside-avoid'>
                ...
                {/*content*/}
                  <div className='p-4 space-y-2 '>
                    ...
                    bottom-1 right-2 max-sm:flex sm:hidden group-hover:flex gap-1.5'>

                      <TrashIcon onClick={()=>handleDelete(thumb._id)} 
                      className='size-8 black/50 p-1 rounded 
                      ...
                      <Link target='_blank' to={`/preview?thumbnail_url=${thumb.image_url}&title=${thumb.title}`}>
                       <ArrowUpRightIcon className='size-8 black/50 p-1 rounded 
                      hover:bg-pink-600 transition-all'/>
                      </Link>
